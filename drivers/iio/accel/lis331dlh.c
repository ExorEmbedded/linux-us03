...
static int lis331dlh_write_event_config(struct iio_dev *indio_dev, u64 event_code, int state)
{
    /* TO BE DONE */
    return 0;
}

static int lis331dlh_read_event_config(struct iio_dev *indio_dev, u64 event_code)
{
    /* TO BE DONE */
    return 0;
}
